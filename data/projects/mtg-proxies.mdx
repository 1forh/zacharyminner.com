...
Search for [tokens](https://www.mtg-proxies.com/tokens), [https://www.mtg-proxies.com/emblems], or [any other type of card](https://www.mtg-proxies.com/cards) that you would like to make a proxy for and add it to your cart. When you've found all of the cards you would like to proxy, click the "Download PDF" button. Once the PDF is downloaded, print out the cards. Then you can cut the cards out, place them in sleeves in front of common cards (lands or something), and then play with them. They'll feel like the real cards in your hand. 👍
