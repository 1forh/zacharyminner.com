...
This example assumes that each document in your collection has a date field. I have a `date` field on each of the documents in my `notes` collection.

<img src={'/static/images/content/firebase-notes-document-example.png'} className="max-w-[500px]" />
