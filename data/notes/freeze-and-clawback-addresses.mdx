...
summary: Just as a bit of a note to myself, generally you don't want to set a freeze or clawback address on the Algorand NFTs you create and want to sell.
---

Just as a bit of a note to myself, generally you don't want to set a freeze or clawback address on the Algorand NFTs you create and want to sell. This might seem like a no-brainer but only if you kow what those are used for. Also, I'm sure there are use cases where these two addresses are useful.
